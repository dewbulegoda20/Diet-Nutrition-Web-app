        ...
        <div className="layout-container flex justify-center w-full">
          <div className="px-4 md:px-10 py-3 flex items-center justify-between w-full max-w-7xl">
            ...
            <nav className="hidden md:flex items-center gap-8">
              <a className="text-text-main font-bold border-b-2 border-primary pb-0.5 transition-colors" href="#">Dashboard</a>
              <a className="text-text-muted text-sm font-medium hover:text-primary transition-colors" href="#">Food Diary</a>
            ...
            <div className="lg:col-span-3 flex flex-col gap-6">
              ...
              <div className="bg-card-light rounded-2xl shadow-xl shadow-gray-200/50 border border-border-light p-6 flex flex-col items-center text-center">
                ...
                <div className="w-full grid grid-cols-3 gap-2 border-t border-border-light pt-6 mb-6">
                  <div className="flex flex-col">
                    ...
                    <span className="text-lg font-bold text-text-main">{user.age || '28'}</span>
                  </div>
                  <div className="flex flex-col border-x border-border-light">
                    ...
                    <span className="text-lg font-bold text-text-main">{user.height || '165'}<span className="text-xs">cm</span></span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-xs text-text-muted uppercase font-bold tracking-wider">Weight</span>
                    <span className="text-lg font-bold text-text-main">{user.weight || '62'}<span className="text-xs">kg</span></span>
                  </div>
                </div>
                
                <button className="w-full py-2.5 rounded-xl border border-border-light text-text-main font-bold hover:bg-gray-50 transition-colors text-sm flex items-center justify-center gap-2">
              ...
              <div className="bg-card-light rounded-2xl shadow-sm border border-border-light p-6">
                ...
                <div className="flex flex-col gap-3">
                  <button className="flex items-center gap-3 p-3 rounded-xl bg-background-light hover:bg-primary/10 transition-colors text-left group">
                  ...
                  <button className="flex items-center gap-3 p-3 rounded-xl bg-background-light hover:bg-blue-500/10 transition-colors text-left group">
                  ...
                  <button className="flex items-center gap-3 p-3 rounded-xl bg-background-light hover:bg-orange-500/10 transition-colors text-left group">
            ...
            <div className="lg:col-span-6 flex flex-col gap-6">
              ...
              <div className="bg-card-light rounded-2xl shadow-sm border border-border-light p-6 md:p-8">
                ...
                <div className="grid grid-cols-3 gap-6">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="w-full h-2 bg-gray-100 rounded-full overflow-hidden">
                      <div className="h-full bg-purple-500 rounded-full" style={{ width: '61%' }}></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-card-light rounded-2xl shadow-sm border border-border-light overflow-hidden">
                ...
                <div className="divide-y divide-border-light">
                  <div className="p-4 hover:bg-background-light transition-colors flex items-center gap-4 group">
                    <div className="size-16 rounded-xl overflow-hidden relative shadow-sm">
                      <img 
                        alt="Oatmeal Breakfast" 
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between mb-1">
                        <h4 className="font-bold text-text-main">Berry Oatmeal Bowl</h4>
                        <span className="font-bold text-text-main">320 kcal</span>
                      </div>
                      <div className="flex items-center gap-2 text-xs text-text-muted">
                        <span className="px-2 py-0.5 rounded bg-gray-100">Breakfast</span>
                        <span>•</span>
                        <span>8:30 AM</span>
                      </div>
                    </div>
                  ...
                  <div className="p-4 hover:bg-background-light transition-colors flex items-center gap-4 group">
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between mb-1">
                        <h4 className="font-bold text-text-main">Grilled Chicken Salad</h4>
                        <span className="font-bold text-text-main">450 kcal</span>
                      </div>
                      <div className="flex items-center gap-2 text-xs text-text-muted">
                        <span className="px-2 py-0.5 rounded bg-gray-100">Lunch</span>
                        <span>•</span>
                        <span>1:15 PM</span>
                      </div>
                    </div>
                  ...
                  <div className="p-4 hover:bg-background-light transition-colors flex items-center gap-4 group">
                    <div className="size-16 rounded-xl flex items-center justify-center bg-blue-50 text-blue-500 shadow-sm">
                      <span className="material-symbols-outlined text-3xl">water_drop</span>
                    </div>
                    <div className="flex-1">
                      <div className="flex justify-between mb-1">
                        <h4 className="font-bold text-text-main">Water Log</h4>
                        <span className="font-bold text-xs uppercase tracking-wide text-blue-500">Hydration</span>
                      </div>
                      <div className="flex items-center gap-2 text-xs text-text-muted">
                        <span className="px-2 py-0.5 rounded bg-blue-100 text-blue-700">500ml</span>
                        <span>•</span>
                        <span>3:00 PM</span>
                      </div>
                    </div>
            ...
            <div className="lg:col-span-3 flex flex-col gap-6">
              ...
              <div className="bg-card-light rounded-2xl shadow-sm border border-border-light p-6">
                ...
                <div className="flex justify-between text-xs text-text-muted mt-2">
                  <span>Start</span>
                  <span>Current: {user.weight || 62}kg</span>
                  <span>Goal</span>
                </div>
                <p className="text-sm text-center mt-4 text-text-main font-medium">
                  You've lost <span className="text-primary font-bold">{(user.weight ? 65 - user.weight : 3)}kg</span> so far!
                </p>
              </div>
